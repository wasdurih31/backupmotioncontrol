...
const SETTINGS_FIELDS = [
  ...
  { key: "price_kling_std", label: "Harga Kling V2.6 MC Std (Rp)", placeholder: "650", description: "Harga per generate Kling V2.6 Motion Control Standard." },
  { key: "price_kling_pro", label: "Harga Kling V2.6 MC Pro (Rp)", placeholder: "1000", description: "Harga per generate Kling V2.6 Motion Control Pro." },
  { key: "price_kling_v3_std", label: "Harga Kling V3 MC Std (Rp)", placeholder: "850", description: "Harga per generate Kling V3 Motion Control Standard." },
  { key: "price_kling_v3_pro", label: "Harga Kling V3 MC Pro (Rp)", placeholder: "1300", description: "Harga per generate Kling V3 Motion Control Pro." },
  { key: "price_kling_v3_i2v_std", label: "Harga Kling V3 I2V Std (Rp)", placeholder: "750", description: "Harga per generate Kling V3 Image-to-Video Standard (suara + 3-15 detik)." },
  { key: "price_kling_v3_i2v_pro", label: "Harga Kling V3 I2V Pro (Rp)", placeholder: "1200", description: "Harga per generate Kling V3 Image-to-Video Pro (suara + 3-15 detik)." },
